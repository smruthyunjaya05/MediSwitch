...
<div align="center">
  <img src="static/assets/demo/home.png" alt="Home Page" width="80%"/>
  <br/><br/>
  <img src="static/assets/demo/recommend.png" alt="Recommendation Page" width="80%"/>
  <br/><br/>
  <img src="static/assets/demo/about.png" alt="About Page" width="80%"/>
  <br/><br/>
  <img src="static/assets/demo/chatbot.png" alt="Chatbot Demo" width="80%"/>
  <br/><br/>
  <video width="80%" controls>
    <source src="static/assets/demo/demo.mp4" type="video/mp4">
...
3. Update the file path for `Medicine_Details.csv` in `app.py` if needed:

   ```python
   file_path = r"./Medicine_Details.csv"  # Use the correct relative or absolute path
   ```
